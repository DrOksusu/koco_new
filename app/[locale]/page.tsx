    ...
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/dashboard" className="btn-primary bg-white text-koco-primary hover:bg-gray-100">
                {t('hero.startButton')}
              </Link>
      ...
      <section className="py-20 bg-koco-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/signup" className="btn-primary bg-white text-koco-primary hover:bg-gray-100 inline-block">
            {t('cta.button')}
          </Link>
        </div>
      </section>
